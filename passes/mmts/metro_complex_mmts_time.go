...
var(
	CasesComplexTimeMMTS=test.Cases{
		...
		{
			N:"6.ММТС-МСК-МСК/Втечение90мин",
			T:test.T{
				&test.Pass{
					PaymentType:test.PaymentTypePayment,
					Carrier:carriers.Carrier_MM,
		...
		{
			N:"8.ММТС-МСК-МСК2/Втечение90мин",
			T:test.T{
				&test.Pass{
					PaymentType:test.PaymentTypePayment,
					Carrier:carriers.Carrier_MM,
		...
		{
			N:"10.ММТС-МСК-МО/Втечение90мин",
			T:test.T{
				&test.Pass{
					PaymentType:test.PaymentTypePayment,
					Carrier:carriers.Carrier_MM,
		...
		{
			N:"10.ММТС-МСК-МО2/Втечение90мин",
			T:test.T{
				&test.Pass{
					PaymentType:test.PaymentTypePayment,
					Carrier:carriers.Carrier_MM,
