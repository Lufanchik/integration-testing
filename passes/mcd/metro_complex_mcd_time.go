	...
	CasesComplexTimeMCD = test.Cases{
		{
			...
			T: test.T{
				&test.Pass{
					...
					Now:         test.NowCustomDate(12, 2, 10, 30),
					ExpectedSum: 4900,
				...
				&test.Pass{
					...
					Ingress: 1,
					Now:     test.NowCustomDate(12, 2, 11, 22),
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MM_SUB,
					Now:         test.NowCustomDate(12, 2, 12, 35),
					Parent:      1,
				},
			},
		},
		{
			...
			T: test.T{
				...
				&test.Pass{
					...
					Ingress: 1,
					Now:     test.NowCustomDate(12, 2, 12, 9),
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MM_SUB,
					Now:         test.NowCustomDate(12, 2, 12, 31),
					Parent:      1,
				},
			},
		},
		{
			...
			T: test.T{
				&test.Pass{
					...
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MM_SUB,
					Now:         test.NowCustomDate(12, 2, 10, 00),
					ExpectedSum: 4200,
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					...
					Now:         test.NowCustomDate(12, 2, 11, 31),
					ExpectedSum: 4200,
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					...
					Now:         test.NowCustomDate(12, 2, 13, 02),
					ExpectedSum: 4200,
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					...
					ExpectedSum: 4200,
					Now:         test.NowCustomDate(12, 2, 14, 33),
				...
				&test.Pass{
					...
					Ingress:     4,
					Now:         test.NowCustomDate(12, 2, 15, 00),
					ExpectedSum: 700,
				},
			},
		},
		{
			...
			T: test.T{
				&test.Pass{
					...
					Now:         test.NowCustomDate(12, 2, 9, 00),
					ExpectedSum: 4900,
					TimeToWait:  60 * time.Minute,
				},
				&test.Pass{
					...
					Ingress: 1,
					Now:     test.NowCustomDate(12, 2, 10, 23),
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					Carrier:     carriers.Carrier_MCD,
					...
					Now:        test.NowCustomDate(12, 2, 11, 00),
					TimeToWait: 5 * time.Minute,
					Parent:     1,
				},
				&test.Pass{
					...
					Ingress: 3,
					Now:     test.NowCustomDate(12, 2, 11, 55),
				},
			},
		},
		{
