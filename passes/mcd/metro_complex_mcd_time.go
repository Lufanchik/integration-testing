	...
	CasesComplexTimeMCD = test.Cases{
		{
			...
			T: test.T{
				&test.Pass{
					...
					Now:         test.NowFullDate(2019, 12, 2, 10, 30, 00),
					ExpectedSum: 4900,
				...
				&test.Pass{
					...
					Ingress: 1,
					Now:     test.NowFullDate(2019, 12, 2, 11, 22, 00),
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MM_SUB,
					Now:         test.NowFullDate(2019, 12, 2, 12, 35, 00),
					Parent:      1,
				},
			},
		},
		{
			...
			T: test.T{
				...
				&test.Pass{
					...
					Ingress: 1,
					Now:     test.NowFullDate(2019, 12, 2, 12, 9, 00),
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MM_SUB,
					Now:         test.NowFullDate(2019, 12, 2, 12, 31, 00),
					Parent:      1,
				},
			},
		},
		...
		},
		{
			...
			T: test.T{
				&test.Pass{
					...
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MM_SUB,
					Now:         test.NowFullDate(2019, 01, 01, 01, 01, 00),
					ExpectedSum: 4200,
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MCK_SUB,
					Now:         test.NowFullDate(2019, 01, 01, 02, 32, 00),
					ExpectedSum: 4200,
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MMTS_SUB,
					Now:         test.NowFullDate(2019, 01, 01, 04, 03, 00),
					ExpectedSum: 4200,
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					...
					ExpectedSum: 4200,
					Now:         test.NowFullDate(2019, 01, 01, 05, 35, 00),
				...
				&test.Pass{
					...
					Ingress:     4,
					Now:         test.NowFullDate(2019, 01, 01, 06, 07, 00),
					ExpectedSum: 700,
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
				...
				&test.Pass{
					...
					Ingress: 6,
					Now:     test.NowFullDate(2019, 1, 1, 7, 58, 00),
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					Carrier:     carriers.Carrier_MCD,
					...
					ExpectedSum: 4200,
					Now:         test.NowFullDate(2019, 1, 1, 8, 30, 00),
					TimeToWait:  10 * time.Minute,
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					...
					Ingress: 8,
					Now:     test.NowFullDate(2019, 1, 1, 8, 53, 00),
				},
				&test.Pass{
					PaymentType: test.PaymentTypePayment,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MMTS_SUB,
					Now:         test.NowFullDate(2019, 1, 1, 10, 11, 00),
					ExpectedSum: 4200,
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					...
					Parent:     10,
					Now:        test.NowFullDate(2019, 1, 1, 10, 45, 00),
				...
				&test.Pass{
					...
					Ingress: 11,
					Now:     test.NowFullDate(2019, 1, 1, 11, 18, 00),
				},
				&test.Pass{
					PaymentType: test.PaymentTypeFree,
					Carrier:     carriers.Carrier_MM,
					SubCarrier:  carriers.SubCarrier_MM_SUB,
					Now:         test.NowFullDate(2019, 01, 01, 11, 31, 00),
					Parent:      10,
				},
			},
		},
